...
if ( ! class_exists( 'ES_Settings' ) ) {
	...
	class ES_Settings {
		...
		public function display_admin_settings() {
			...
			<tr class="es-admin active-settings">
				<th scope="row">
					<label for="elp"><?php echo __( 'Edit Subscribe shortcode location', ES_TDOMAIN ); ?>
					<p class="description"><?php echo __( 'Input the page address where the edit shortcode appears, include slashes', ES_TDOMAIN ); ?></p></label>
				</th>
				<td>
					<input name="es_c_shortcodepage" id="es_c_shortcodepage" type="text" value="<?php echo esc_html(stripslashes($this->form['ig_es_shortcodepage'])); ?>"  size="60" maxlength="225" />
				</td>
			</tr>
			<? //end edit page ?>
		...
		public function es_process_settings_data() {
			...
			//edit data
			$form['ig_es_shortcodepage'] = get_option('ig_es_shortcodepage');
			...
			if (isset($_POST['es_form_submit']) && $_POST['es_form_submit'] == 'yes') {
				...
				//edit page
				$form['ig_es_shortcodepage'] = isset($_POST['es_c_shortcodepage']) ? $_POST['es_c_shortcodepage'] : '';
